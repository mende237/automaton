...
/*cette fonction retourne pour un etat donnée */
static void **delta_global_AFN(AFN afn, list state, boolean equal_label(void *lb1, void *lb2));
/**/
...
boolean equal_state(list st1, list st2 , int permut);
